...
var STRENGTH_TEST_THEME = load("res://Assets/SFX/happy_theme.ogg")
...
'GAME_OVER_THEME':GAME_OVER_THEME, 'BOSS_THEME':BOSS_THEME, 'STRENGTH_TEST_THEME': STRENGTH_TEST_THEME}
